...
inline Tensor dispatch_norm(const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim, Tensor result) {

  AutoNoGIL no_gil;
  return at::norm_out(result, self, p, dim, keepdim);
}
inline Tensor dispatch_norm(const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim) {
