...
struct CAFFE2_API TypeDefault : public TypeExtendedInterface {
  ...
  Tensor norm(const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim) const override;
  Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim) const override;
