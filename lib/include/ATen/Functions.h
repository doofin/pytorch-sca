...
static inline Tensor norm(const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim=false);
static inline Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim=false);
...
static inline Tensor norm(const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim) {
    return detail::infer_type(self).norm(self, p, dim, keepdim);
}
static inline Tensor & norm_out(Tensor & result, const Tensor & self, c10::optional<Scalar> p, int64_t dim, bool keepdim) {
